...
You can also get a raster of monthly and annual climate data for an area:
...
ggplot() +
  ...
  facet_wrap(~lyr, ncol = 2) +
  scale_fill_whitebox_c(name = "Minimum monthly\ntemperature (ºC)", palette = "muted") +
  theme_bw()


Sys.time()

ras_annual_tmin <- get_annual_climate(
  coords_t,
  period = c(2012),
  climatic_var = "Tmin",
  output = "raster" # return raster
...
ggplot() +
  geom_spatraster(data = ras_annual_tmin, alpha = 0.9) +
  facet_wrap(~lyr, ncol = 2) +
  scale_fill_whitebox_c(name = "Minimum annual\ntemperature (ºC)", palette = "muted") +
  theme_bw()
