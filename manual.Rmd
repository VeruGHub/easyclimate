...
###2.1. tile_selection (POR TERMINAR)
...
Currently almost finished done for Spain.
...
Para mejorar:
-Tarda mucho en extraer y se podría optimizar
-Que para cada punto extraiga información de los años de interés que varían entre puntos
