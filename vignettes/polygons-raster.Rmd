...
Now you know how to extract climatic variables with `easyclimate`, for a specific area. Check out this [other vignette](https://verughub.github.io/easyclimate/docs/articles/points-df-mat-sf.html) it you need to extract the data for specific points.
