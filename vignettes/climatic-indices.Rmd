...
Temperature and precipitation units are ºC\*100 and mm\*100 to avoid floating values. Here we convert them to ºC and mm, and calculate daily mean temperature:
...
Similarly, you can calculate accumulated precipitations over different time periods: 
...
Sometimes it can be useful to calculate the deviation of climatic values from a reference period. For example, considering all the data downloaded as the reference period, you could calculate the deviations per site and year as follows:
...
<br>
Number of days with temperature > 32ºC in summer (June-August):
...
For learning all the details about downloading daily climatic data, please consult [this vignette](https://verughub.github.io/easyclimate/docs/articles/points-df-mat-sf.html) for point coordinates, or [this other](https://verughub.github.io/easyclimate/docs/articles/polygons-raster.html) if you need to extract data for several polygons or a region.
