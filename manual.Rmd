...
###2.4.1. annual_prec
Annual precipitation from daily values. The output is a data.frame with a row per points and year with the annual precipitation and the number of daily NAs. Optionally the mean precipitation could be calculated for each location using the selected years.
A function of:
